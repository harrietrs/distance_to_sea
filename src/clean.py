...
def calc_distance_to_sea(coast_boundaries: str = params.coast_boundaries_file):
    ...
    Args:
        coast_boundaries (str, optional): _description_. Defaults to params.coast_boundaries_file.
...
def clean_distance_to_sea(calculate: bool = False, raw_file: str = params.distance_to_sea_file):
    """
    ...
    """
    if calculate:
        distance_to_sea = calc_distance_to_sea()
    else:
